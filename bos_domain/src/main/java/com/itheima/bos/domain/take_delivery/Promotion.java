...
public class Promotion implements Serializable {
	...
	public String getDescription() {
		if(description.contains(Constants.BOS_MANAGEMENT_HOST)){
			return description;
		}
		String start = description.substring(0, description.indexOf("/"));

		String end = description.substring(description.indexOf("/"));
		return start+Constants.BOS_MANAGEMENT_HOST+end;
	}
