...
public class MailUtils {
	...
	private static String username = "zx15091318309@163.com"; // 邮箱账户
	private static String password = "187914zxao"; // 邮箱授权码

	private static String from = "zx15091318309@163.com"; // 使用当前账户
